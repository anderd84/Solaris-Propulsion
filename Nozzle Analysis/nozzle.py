import numpy as np
from gas import MachAngle, SpHeatRatio, PrandtlMeyerFunction, Isentropic1DExpansion
...
def RaoContourFormat(contour):
    return np.array([ContourPoint(p.x, p.r) for p in contour[::-1]])